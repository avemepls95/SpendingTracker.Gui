 ...
 *
 * Нужно фоновым запросам, которые уходят по мере ввода: предпросмотр дат
 * пересчитывается на каждое изменение правила, и его отказ уже показан прямо
 * в блоке предпросмотра. Плашка поверх этого только мешала бы вводу.
 */

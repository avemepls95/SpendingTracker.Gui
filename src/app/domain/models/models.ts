...
export interface Tag {
  ...
  /**
   * Тег переезжает на новые траты с тем же описанием.
   *
   * Словарь разметки ключуется описанием, а теги бывают двух природ: одни
   * описывают саму трату («регулярные расходы» на «интернет в квартире»), другие -
   * обстоятельства («израиль» на «кофе»). Переносить можно только первые, поэтому
